                ...
                <FadeIn direction="up">
                    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                        ...
                        <div className="mt-12">
                            <button
                                onClick={openModal}
                                className="inline-flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-full text-gray-900 bg-primary hover:bg-yellow-400 md:py-4 md:text-lg md:px-10 transition-all shadow-lg hover:shadow-primary/50"
                            >
                                Join Our Mission
                            </button>
                        </div>
